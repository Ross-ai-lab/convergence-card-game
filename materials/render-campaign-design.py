...
parts.append('<section class="panel" id="route"><h2>The proposed campaign order</h2><p class="intro">Begin against formations and combat specialists. Advance through control decks, pirate emperors and cosmic threats. Bill Cipher is the final encounter. These placements are a design proposal, not measured difficulty rankings.</p><div class="note">Chunks 1 and 2 are implemented: definitions, validation and the separate-deck engine. Campaign menus and progression are next. Chapters 1–9 give nine cards each to preserve complete larger universe packs later. Chapter 20 keeps its own one-card reward.</div><div class="route">')
cumulative=30
for ch in chapters:
