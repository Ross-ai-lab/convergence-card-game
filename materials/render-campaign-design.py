...
parts.append('<section class="panel" id="route"><h2>The proposed campaign order</h2><p class="intro">Begin against formations and combat specialists. Advance through control decks, pirate emperors and cosmic threats. Bill Cipher disrupts reality before Saitama closes the campaign. These placements are a design proposal, not measured difficulty rankings.</p><div class="note">All four campaign chunks are implemented: twenty character opponents, custom decks, fixed rewards, progression and save/reset handling. Chapter 1 gives ten cards; chapters 2–5 give ten; chapter 6 gives eight; chapter 7 gives nine; chapter 8 gives eight; chapters 9–10 give nine; chapters 11–12 give eight. Chapter 17 gives Bill Cipher eight cards; chapter 20 keeps the final One-Punch Man reward.</div><div class="route">')
cumulative=30
for ch in chapters:
...
for tab,field,title in [('decks','deckCardIds','Twenty fixed opponent decks'),('rewards','rewardCardIds','Every first-clear reward')]:
    ...
    else:parts.append('<p>Thirty starter cards plus these 188 rewards cover all 218 cards exactly once. No pack rerolls. No daily, loss, draw or replay rewards.</p>')
    for ch in chapters:
