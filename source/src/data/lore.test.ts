...
describe("Star Chart coverage", () => {
  ...
  it("keeps the new visible narrative fields lore-only", () => {
    const addedIds = ["c176", "c177", "c178", "c179", "c180", "c181", "r001", "r002", "r003", "r005", "r006", "r007", "r008", "r009", "r010", "r011", "r012", "r013", "r014", "r015", "r016", "r017", "r018", "r019", "r020", "r021", "r022", "r023", "r024", "r025", "r026", "r027", "r028"];
