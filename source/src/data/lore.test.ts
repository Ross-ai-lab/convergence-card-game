...
describe("Star Chart coverage", () => {
  ...
  it("includes the newly requested character and Relic profiles", () => {
    ...
    expect(["r001", "r002", "r003", "r005", "r006", "r007", "r008", "r009", "r010", "r011", "r012", "r013", "r014", "r015", "r016", "r017", "r018", "r019", "r020", "r021", "r022", "r023", "r024", "r025", "r026", "r027", "r028", "r029", "r030", "r031", "r032", "r033", "r034", "r035"].every((id) => id in LORE_DETAILS)).toBe(true);
  });

  it("keeps the new visible narrative fields lore-only", () => {
    const addedIds = ["c176", "c177", "c178", "c179", "c180", "c181", "c182", "c183", "c184", "c185", "r001", "r002", "r003", "r005", "r006", "r007", "r008", "r009", "r010", "r011", "r012", "r013", "r014", "r015", "r016", "r017", "r018", "r019", "r020", "r021", "r022", "r023", "r024", "r025", "r026", "r027", "r028", "r029", "r030", "r031", "r032", "r033", "r034", "r035"];
