...
export const LORE_DETAILS: Record<string, LoreDetail> = {
  ...
  "c021": {
    ...
    "ability": "Battlecry: Destroy an enemy minion",
    "rivals": [
      {
        "who": "L",
        "rel": "nemesis, mutual obsession",
  ...
  "c022": {
    ...
    "ability": "Passive: All enemy minions are temporarily silenced",
    "rivals": [
      {
        "who": "Sukuna",
        "rel": "eventually kills him",
  ...
  "c027": {
    ...
    "ability": "Battlecry: Reduce the number of minions on the board by half, chosen randomly",
    "rivals": [
      {
        "who": "Iron Man",
  ...
  "c077": {
    ...
    "ability": "Taunt. Passive: Evade 60% of attacks",
    "rivals": [
      {
        "who": "Saitama",
  ...
  "c162": {
    ...
    "playstyle": "Permanently seals two board slots",
    "ability": "Deathrattle: Bind two empty slots on the board, one for each side. These slots cannot hold minions for the rest of the game",
    "rivals": [
      {
        "who": "Muzan Kibutsuji",
  ...
  "r029": {
    "name": "Omnitrix",
    "origin": "Ben 10",
    "epithet": "The Universal DNA Watch",
    "rar": "Relic",
    "camp": "Ascension",
    "align": "Relic",
    "cost": 3,
    ...
    "rank": "Ben 10 · Omnitrix device",
    "lore": "The Omnitrix is a device created by Azmuth that lets its wearer access the genetic templates of many alien species. It was designed as a tool for understanding and peace, but its range of forms makes it one of the most dangerous objects in the galaxy.",
    "quote": "It's hero time!",
    "str": [
      "Stores a library of alien forms",
      "Turns adaptation into identity",
      "Makes knowledge a source of power"
    ],
    "wk": [
      "Its transformations have time limits",
      "The watch can choose the wrong form",
      "Its creator fears what others would do with it"
    ],
    "sig_name": "Alien Selection",
    "sig_desc": "A flash of green light opens a new body and a new answer to the problem in front of it.",
    "playstyle": "A device of endless adaptation and imperfect control",
    "ability": "The Omnitrix allows its user to transform into sampled alien species while preserving a path back to human form.",
    "rivals": [
      {
        "who": "Ben Tennyson",
        "rel": "the watch's young wielder",
        "id": ""
      },
      {
        "who": "Azmuth",
        "rel": "its Galvan creator",
        "id": ""
      },
      {
        "who": "Vilgax",
        "rel": "conqueror who seeks its power",
        "id": ""
      }
    ]
  },
  "r030": {
    ...
    "epithet": "The Arrow That Awakens Stands",
    "rar": "Relic",
    "camp": "Ascension",
    "align": "Relic",
    "cost": 2,
    ...
    "rank": "JoJo · Stand-creating Arrow",
    "lore": "The Stand Arrows are mysterious weapons made from a meteorite carrying an otherworldly virus. Those who survive the piercing may awaken a Stand, while those who cannot endure it are left behind by the same force that grants another person extraordinary power.",
    "quote": "The arrow chooses.",
    "str": [
      "Awakens hidden potential",
      "Turns a wound into a new identity",
      "Links separate lives to one mystery"
    ],
    "wk": [
      "Many victims do not survive",
      "Its origin remains obscure",
      "Power depends on the person's response"
    ],
    "sig_name": "Stand Awakening",
    "sig_desc": "A single point of contact divides an ordinary life from the strange ability waiting beneath it.",
    "playstyle": "A dangerous gamble that rewards those who endure transformation",
    "ability": "The Stand Arrow can awaken a supernatural Stand in someone who survives its power.",
    "rivals": [
      {
        "who": "Enya the Hag",
        "rel": "dealer in the Arrows' power",
        "id": ""
      },
      {
        "who": "Giorno Giovanna",
        "rel": "wielder who reaches Requiem",
        "id": "c042"
      },
      {
        "who": "Diavolo",
        "rel": "seeker of the Arrow's final evolution",
        "id": ""
      }
    ]
  },
  "r031": {
    "name": "Poké Ball",
    "origin": "Pokémon",
    "epithet": "The Trainer's Capture Device",
    "rar": "Relic",
    "camp": "Ascension",
    "align": "Relic",
    "cost": 1,
    ...
    "rank": "Pokémon · Capsule for partners",
    "lore": "A Poké Ball is a compact device used to carry Pokémon between journeys and battles. Its small shape hides a carefully tuned interior, turning a powerful creature's movement between the wild and a trainer's side into a familiar red-and-white gesture.",
    "quote": "Gotta catch them all!",
    "str": [
      "Makes partnership portable",
      "Bridges wild and civilised spaces",
      "Holds more than its size suggests"
    ],
    "wk": [
      "A Pokémon may resist capture",
      "The device is only useful with trust",
      "Not every species fits the same ball"
    ],
    "sig_name": "Recall",
    "sig_desc": "A red flash folds a travelling partner into a safe capsule until the next call to action.",
    "playstyle": "A simple tool built around trust, timing, and return",
    "ability": "Poké Balls allow trainers to capture, carry, and call their Pokémon partners during a journey.",
    "rivals": [
      {
        "who": "Ash Ketchum",
        "rel": "trainer whose partners define his journey",
        "id": ""
      },
      {
        "who": "Professor Oak",
        "rel": "researcher of Pokémon and their habitats",
        "id": ""
      },
      {
        "who": "Mewtwo",
        "rel": "powerful being that resists human control",
        "id": ""
      }
    ]
  },
  "r032": {
    "name": "Time Turner",
    "origin": "Harry Potter",
    "epithet": "The Hourglass of Reversal",
    "rar": "Relic",
    "camp": "Ascension",
    "align": "Relic",
    "cost": 2,
    ...
    "rank": "Harry Potter · Ministry time device",
    "lore": "A Time-Turner is a magical hourglass that lets its user revisit a limited span of time. Hermione Granger uses one to attend overlapping lessons, and later stories show how even a small change in chronology can carry enormous consequences.",
    "quote": "Minutes become possibilities.",
    "str": [
      "Makes lost time reachable",
      "Rewards careful planning",
      "Turns sequence into a resource"
    ],
    "wk": [
      "Its range is tightly limited",
      "Paradoxes threaten careless users",
      "The Ministry restricts its use"
    ],
    "sig_name": "Rewind",
    "sig_desc": "Sand falls upward for a moment, returning a wound to the instant before it was made.",
    "playstyle": "A precise answer to damage that depends on remembering when it began",
    "ability": "A Time-Turner allows a witch or wizard to revisit a recent period of time through a charmed hourglass.",
    "rivals": [
      {
        "who": "Hermione Granger",
        "rel": "student who uses one to manage her studies",
        "id": ""
      },
      {
        "who": "Albus Dumbledore",
        "rel": "headmaster who understands its danger",
        "id": "c030"
      },
      {
        "who": "The Department of Mysteries",
        "rel": "Ministry authority that studies time",
        "id": ""
      }
    ]
  },
  "r033": {
    ...
    "rank": "Marvel · Klyntar organism",
    "lore": "A symbiote is a living alien organism that bonds with a host and shares its senses, strength, and instincts. The relationship can become a partnership like Venom and Eddie Brock, or a struggle in which hunger and identity threaten to consume the person inside the suit.",
    "quote": "We are Venom.",
    "str": [
      "Shares power through partnership",
      "Heals and protects its host",
      "Learns from every conflict"
    ],
    "wk": [
      "The bond can become possessive",
      "Fire and sound can hurt it",
      "Host and organism can disagree"
    ],
    "sig_name": "Second Chance",
    "sig_desc": "When the host should fall, the living suit holds the body together for one more struggle.",
    "playstyle": "A dangerous partnership that converts survival into dependence",
    "ability": "Marvel symbiotes bond with hosts to grant strength, healing, and a shared identity at a personal cost.",
    "rivals": [
      {
        "who": "Eddie Brock",
        "rel": "host who forms the Venom partnership",
        "id": ""
      },
      {
        "who": "Peter Parker",
        "rel": "first human host of the black suit",
        "id": ""
      },
      {
        "who": "Knull",
        "rel": "creator and god of the symbiotes",
        "id": ""
      }
    ]
  },
  "r034": {
    ...
    "rank": "Men in Black · Memory eraser",
    "lore": "The neuralyzer is a compact device used by the Men in Black to erase or replace memories with a flash of light. It keeps the hidden alien world from becoming public knowledge, while leaving its agents responsible for deciding which truths ordinary people are allowed to remember.",
    "quote": "Look right here.",
    "str": [
      "Erases dangerous knowledge",
      "Protects a secret world",
      "Solves conflict without visible force"
    ],
    "wk": [
      "Its use can be abused",
      "The erased truth may return",
      "Memory is not the same as understanding"
    ],
    "sig_name": "Flash of Forgetting",
    "sig_desc": "A white pulse clears the mental residue of curses, fear, and unwanted control.",
    "playstyle": "A quiet reset button for a battlefield full of lingering consequences",
    "ability": "Men in Black agents use neuralyzers to erase or alter memories and preserve secrecy after supernatural encounters.",
    "rivals": [
      {
        "who": "Agent K",
        "rel": "veteran agent who carries the device",
        "id": ""
      },
      {
        "who": "Agent J",
        "rel": "partner learning the cost of secrecy",
        "id": ""
      },
      {
        "who": "The Arquillian Prince",
        "rel": "alien crisis hidden from humanity",
        "id": ""
      }
    ]
  },
  "r035": {
    ...
    "rank": "DC · Green Lantern power ring",
    "lore": "A Green Lantern power ring is an advanced device powered by will and connected to the emotional spectrum. It translates a Lantern's imagination into solid light, grants flight and protection, and answers most strongly when its wielder refuses to surrender.",
    "quote": "In brightest day, in blackest night.",
    "str": [
      "Turns imagination into solid light",
      "Rewards courage and discipline",
      "Connects one bearer to a wider corps"
    ],
    "wk": [
      "Requires a strong will",
      "The ring's charge is finite",
      "Fear can interfere with its power"
    ],
    "sig_name": "Hard-Light Construct",
    "sig_desc": "The ring shapes resolve into a weapon, shield, or bridge before the next choice has to be made.",
    "playstyle": "A tool that grows through patience, courage, and creative defence",
    "ability": "Green Lantern rings create hard-light constructs and empower their chosen wielders through willpower.",
    "rivals": [
      {
        "who": "Hal Jordan",
        "rel": "test pilot chosen by Abin Sur's ring",
        "id": ""
      },
      {
        "who": "John Stewart",
        "rel": "architect and Lantern whose constructs reflect precision",
        "id": ""
      },
      {
        "who": "The Guardians of the Universe",
        "rel": "creators and overseers of the Corps",
        "id": ""
      }
    ]
  },
